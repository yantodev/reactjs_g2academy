...
class Table extends Component {
    ...
    return (
      <div>
        ...
        <div className="container col-md-12">
          <h3 style={{ textAlign: "center" }}>Tabel Siswa</h3>
          <div style={{ float: "left" }}>
            <button
              onClick={this.showTambahData}
              style={{ margin: "15px" }}
              className={"btn " + this.state.toggleTambahData.button}
            >
              {this.state.toggleTambahData.text}
            </button>
          </div>
          <table
                ...
                return (
                  <tr key={index}>
                    ...
                    <td style={{ width: 20 + "%", whiteSpace: "nowrap" }}>
                      <center>
                        <button
                          onClick={this.saveEditSiswa.bind(this, index)}
                        ...
                        <button
                          onClick={this.editSiswa.bind(this, index)}
                          className={
                            "btn btn-edit " + val.toggleEditData.button
                          }
                          style={{ marginRight: 10 + "px" }}
                        >
                          {val.toggleEditData.text}
                        </button>
                        <button
                          onClick={this.deleteSiswa}
                          className="btn btn-danger btn-hapus"
                        >
                          Delete
                        </button>
                      </center>
  ...
  cekSubmit(e) {
    ...
    if (
      !/^[a-zA-Z ]*$/.test(this.state.nama) ||
      this.state.nama.trim().length === 0
    ) {
  ...
  showTambahData(e) {
    ...
    if (toggle.action === 1) {
      this.setState({
        isShow: "",
        toggleTambahData: { action: 2, button: "btn-warning", text: "Batal" },
      });
    } else {
      this.setState({
        isShow: "none",
